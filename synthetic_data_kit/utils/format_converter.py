...
def to_hf_datasetdict(qa_pairs: List[Dict[str, str]], output_path: str) -> str:
    """
    Convert QA pairs to a Hugging Face DatasetDict 
    ...
    Returns:
        Path to the saved datasetdict directory
    """
    try:
